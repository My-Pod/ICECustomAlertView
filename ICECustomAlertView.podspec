...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ICECustomAlertView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/ICECustomAlertView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gumengxiao' => 'rare_ice@163.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ICECustomAlertView.git', :tag => s.version.to_s }
